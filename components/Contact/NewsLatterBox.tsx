...
const NewsLatterBox = () => {
  ...
  return (
    ...
    >
      ...
      Join our mailing list to get the latest updates on robotics workshops, project ideas, and exclusive offers from Botshala – your hands-on robotics learning partner.
      </p>
      <div>
        <input
          type="text"
